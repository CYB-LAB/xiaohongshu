package com.itpractice.xiaohongshu.kv.biz.consumer;

import com.itpractice.framework.common.utils.JsonUtils;
import com.itpractice.xiaohongshu.kv.biz.constant.MQConstants;
import com.itpractice.xiaohongshu.kv.biz.model.dto.PublishNoteDTO;
 ...
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaohongshu_group_" + MQConstants.TOPIC_PUBLISH_NOTE_TRANSACTION, // Group 组
