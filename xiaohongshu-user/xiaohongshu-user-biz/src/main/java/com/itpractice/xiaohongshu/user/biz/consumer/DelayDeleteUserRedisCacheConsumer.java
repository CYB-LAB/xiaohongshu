package com.itpractice.xiaohongshu.user.biz.consumer;
...
@Component
@Slf4j
@RocketMQMessageListener(consumerGroup = "xiaohongshu_group_" + MQConstant.TOPIC_DELAY_DELETE_USER_REDIS_CACHE, // Group
        topic = MQConstant.TOPIC_DELAY_DELETE_USER_REDIS_CACHE // 消费的主题 Topic
)
