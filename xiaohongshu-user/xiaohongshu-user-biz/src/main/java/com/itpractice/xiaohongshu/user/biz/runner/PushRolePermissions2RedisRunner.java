package com.itpractice.xiaohongshu.user.biz.runner;
...
import com.itpractice.xiaohongshu.user.biz.domain.dataobject.PermissionDO;
import com.itpractice.xiaohongshu.user.biz.domain.dataobject.RoleDO;
import com.itpractice.xiaohongshu.user.biz.domain.dataobject.RolePermissionDO;
import com.itpractice.xiaohongshu.user.biz.domain.mapper.PermissionDOMapper;
import com.itpractice.xiaohongshu.user.biz.domain.mapper.RoleDOMapper;
import com.itpractice.xiaohongshu.user.biz.domain.mapper.RolePermissionDOMapper;
...
public class PushRolePermissions2RedisRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        try {
            ...
            log.error("==> 服务启动，同步角色权限数据到 Redis 中异常: ", e);
        }
    }
